package com.portfolio.backend.application.views.talkview;
...
@PageTitle("TalkView")
@Menu(icon = "line-awesome/svg/comments.svg", order = 6)
@Route(value = "TalkView")
@RolesAllowed("ADMIN")
public class TalkViewView extends HorizontalLayout {
    ...
    public TalkViewView() {
        addClassNames("talk-view-view", Width.FULL, Display.FLEX, Flex.AUTO);
        setSpacing(false);
