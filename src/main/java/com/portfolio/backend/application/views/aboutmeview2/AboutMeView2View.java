package com.portfolio.backend.application.views.aboutmeview2;
...
@PageTitle("AboutMeView2")
@Menu(icon = "line-awesome/svg/info-solid.svg", order = 2)
@Route(value = "AboutMeView2")
@RolesAllowed("ADMIN")
public class AboutMeView2View extends Div {
    ...
    public AboutMeView2View() {
        addClassName("about-me-view2-view");
        setSizeFull();
        createGrid();
        add(grid);
    }
